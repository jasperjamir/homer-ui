/** biome-ignore-all lint/correctness/useExhaustiveDependencies: <Shadcn UI components> */
/** biome-ignore-all lint/correctness/useUniqueElementIds: <Shadcn UI components> */
/** biome-ignore-all lint/correctness/noNestedComponentDefinitions: <Shadcn UI components> */
        ...
        <PopoverTrigger asChild disabled={disabled}>
          <Button
            ...
            className={cn(
              ...
              !displayDate && "text-muted-foreground/60",
              className,
            )}
            ref={buttonRef}
          >
